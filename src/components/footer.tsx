...
import { useSiteSettings, useNavigation } from "@/lib/content/hooks";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <Typography variant="body1" className="text-text-dark mb-4">
              {settings.tagline.split("&").map((part, i) => (
                <span key={i}>
                  {i > 0 && (
                    <>
                      &<br />
                  ...
                  {part.trim()}
                  {i === 0 && settings.tagline.includes("&") ? " " : ""}
                </span>
              ))}
              {!settings.tagline.includes("&") && settings.tagline}
            </Typography>
          </div>
